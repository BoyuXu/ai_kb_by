...
$$
\text{ROI} = \frac{\text{Revenue} - \text{Cost}}{\text{Cost}} = \frac{\sum_i \text{bid}}_{\text{i \times \mathbb{1}}[\text{win}}_{\text{i] \times \text{CVR}}_i \times \text{value}}_{\text{i - \sum}}_{\text{i \text{cost}}_i}{\sum_i \text{cost}}_{\text{i}}
$$
...
$$
\text{Fill}}_{\text{{\text{Rate}}} = \frac{\text{有广告填充的请求数}}{\text{总请求数}}, \quad \text{eCPM}}_{\text{{\text{floor}}}: \text{score} > \theta
$$
