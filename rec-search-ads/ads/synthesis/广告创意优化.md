...
> - [Qarm Quantitative Alignment Multi-Modal Recomme...](../../ads/papers/Qarm_Quantitative_Alignment_Multi_modal_Recommendation_at.md) — Qarm: Quantitative Alignment Multi-modal Recommendation a...
> - [Multi-Objective-Ads-Ranking](../../ads/papers/MMoE_PLE_Pareto.md) — 多目标广告排序：MMoE、PLE 与 Pareto 优化
> - [Ads-Budget-Optimization](../../ads/papers/Ads_Budget_Optimization.md) — 广告预算优化（Ads Budget Optimization）
> - [Llm Ad Creative Generation](../../ads/papers/LLM_Enhanced_Ad_Creative_Generation_and_Optimization_for.md) — LLM-Enhanced Ad Creative Generation and Optimization for ...
