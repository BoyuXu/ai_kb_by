...
> - [[Large_Language_Model_as_Universal_Retriever_in_Industrial|Llm-Universal-Retriever]] — Large Language Model as Universal Retriever in Industrial...
...
> - [[Towards_Web_scale_Recommendations_with_LLMs_From_Quality|Web-Scale-Llm-Recsys]] — Towards Web-scale Recommendations with LLMs: From Quality...
> - [[Dense_Passage_Retrieval_for_Open_Domain_Question_Answerin|Dense Passage Retrieval For Open-Domain Questio...]] — Dense Passage Retrieval for Open-Domain Question Answerin...
...
graph TD
    subgraph 推荐["推荐系统"]
        R1["多路召回<br/>CF/Dense/热门/实时"]
        R2["URM 统一召回器<br/>LLM + 生成式框架"]
        R3["Q' Recall<br/>LLM生成新候选"]
    end

    subgraph 广告["广告系统"]
        A1["广告召回<br/>关键词匹配/定向"]
        A2["LLM语义召回<br/>广告-query语义匹配"]
        A3["创意生成召回<br/>LLM生成广告文案"]
    end

    subgraph 搜索["搜索系统"]
        S1["稀疏检索<br/>BM25/倒排索引"]
        S2["稠密检索<br/>DPR/双塔Embedding"]
        S3["LLM查询改写<br/>Query Expansion"]
    end

    LLM["LLM通用能力<br/>语义理解+生成"]
