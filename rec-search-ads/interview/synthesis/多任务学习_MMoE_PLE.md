...
> 📚 参考文献
> - [Moe-Llama Mixture-Of-Experts For Efficient Larg... [BROKEN]](../../../llm-agent/llm-infra/20260323_moe-llama_mixture-of-experts_for_efficient_large_la.md) — MoE-LLaMA: Mixture-of-Experts for Efficient Large Languag...
> - [Moe-Llama-Mixture-Of-Experts-Efficient-Llm-Serving [BROKEN]](../../../llm-agent/llm-infra/20260321_moe-llama-mixture-of-experts-efficient-llm-serving.md) — MoE-LLaMA: Mixture-of-Experts for Efficient Large Languag...
> - [Moe-Llama-Mixture-Of-Experts-For-Efficient-Larg... [BROKEN]](../../../llm-agent/llm-infra/20260321_moe-llama-mixture-of-experts-for-efficient-large-language-model-serving.md) — MoE-LLaMA: Mixture-of-Experts for Efficient Large Languag...
...
> - [Llm-Enhanced-Ad-Creative-Generation-And-Optimiz... [BROKEN]](../../ads/papers/LLM_Enhanced_Ad_Creative_Generation_and_Optimization_for.md) — LLM-Enhanced Ad Creative Generation and Optimization for ...
> - [Mmoe-Multi-Task-Learning [BROKEN]](../../rec-sys/papers/MMoEMulti_gate_Mixture_of_Experts.md) — MMoE：多门控混合专家（Multi-gate Mixture-of-Experts）
> - [Llm-For-Ir-Survey [BROKEN]](../../search/papers/Large_Language_Models_for_Information_Retrieval_A_Survey.md) — Large Language Models for Information Retrieval: A Survey
