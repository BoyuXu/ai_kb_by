...
> - [Jensen-Gap-Fairness-Rec](../../rec-sys/papers/Bridging_Jensen_Gap_for_Max_Min_Group_Fairness_Optimizati.md) — Bridging Jensen Gap for Max-Min Group Fairness Optimizati...
> - [Query As Anchor Llm User Repr](../../search/papers/Query_as_Anchor_Scenario_Adaptive_User_Representation_via_v2.md) — Query as Anchor: Scenario-Adaptive User Representation vi...
