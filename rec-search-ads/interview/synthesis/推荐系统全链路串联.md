...
$$
\text{Overall}}_{\text{{\text{CVR}}} = \prod_{k=1}^{K} P(\text{stage}}_{\text{k | \text{stage}}_{k-1})
$$
...
$$
\text{score}}_{\text{{\text{final}}}(i) = \max_c \text{score}}_{\text{c(i), \quad \text{or}} \quad \text{score}}_{\text{{\text{final}}}(i) = \sum_c w_c \cdot \text{norm}(\text{score}}_{\text{c(i))
$$
...
$$
T}}_{\text{{\text{total}}} \leq T_{\text{recall}} + T_{\text{prerank}} + T_{\text{rank}} + T_{\text{rerank}} + T_{\text{network}}
$$
