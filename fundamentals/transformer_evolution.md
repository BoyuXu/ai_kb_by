...
> 关联：[[fundamentals/attention_transformer]] | [[fundamentals/kv_cache_inference]] | [[fundamentals/activation_functions]] | [[synthesis/llm/08_LLM预训练与架构演进]] | [[synthesis/llm/07_MoE架构与稀疏激活]] | [[concepts/attention_in_recsys]]
...
> 详细基础见 [[fundamentals/attention_transformer]]，本节聚焦变体对比。
...
> 详细激活函数对比见 [[fundamentals/activation_functions]]。
...
> KV Cache 优化详见 [[fundamentals/kv_cache_inference]]。
...
> 详见 [[synthesis/llm/07_MoE架构与稀疏激活]]。
...
> 基本原理和详细对比见 [[fundamentals/kv_cache_inference]]。
...
> - 原始 Attention 机制+搜广推应用 → [[fundamentals/attention_transformer]]
> - KV Cache 推理优化详解 → [[fundamentals/kv_cache_inference]]
> - 预训练里程碑+Scaling 策略 → [[synthesis/llm/08_LLM预训练与架构演进]]
> - MoE 架构详解 → [[synthesis/llm/07_MoE架构与稀疏激活]]
> - Attention 在搜广推的应用 → [[concepts/attention_in_recsys]]
> - 激活函数基础 → [[fundamentals/activation_functions]]