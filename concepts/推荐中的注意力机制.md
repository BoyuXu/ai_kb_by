...
**相关概念页**：[[sequence_modeling_evolution|序列建模演进]] | [[embedding_everywhere|Embedding全景]] | [[generative_recsys|生成式推荐]] | [[transformer_evolution]] | [[taac2026_kdd_competition|TAAC2026 KDD 比赛]]
...
- [[20260421_llm_auction_and_delayed_feedback|20260421 LLM拍卖+延迟反馈(BAR Task-Attentive)]]
- [[bytedance_recsys_transformer|字节系搜广推Transformer演进(DHEN/RankMixer/HyFormer/OneTrans)]]
- [[20260504_speculative_decoding_longcontext_quant|20260504 MLA将attention从memory-bound变为compute-bound + CuBridge注意力核自动生成]]
- [[20260513_ads_bidding_creative_benchmark|SUIN: User-Aware Target Attention联合item-item和user-user相关性增强CTR]]
